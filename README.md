...
2. S3 file storage
3. Upload with server
4. Single and multiple attached files

### Not tested

1. Direct upload from browser
2. Variants
3. Analyzers (Image and Video)
4. Previewers (PDF and Video)
5. GCS, Mirror and Azure services
